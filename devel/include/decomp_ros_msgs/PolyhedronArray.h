...
struct PolyhedronArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::decomp_ros_msgs::Polyhedron_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::decomp_ros_msgs::Polyhedron_<ContainerAllocator> >> _polyhedrons_type;
